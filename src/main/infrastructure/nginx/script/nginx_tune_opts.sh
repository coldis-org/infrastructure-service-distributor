...
#	THREAD_QUEUE_MEM_PERC=3000
	...
	echo "nginx_tune_opts: [INFO] MAX_MEMORY=${MAX_MEMORY}"
	echo "nginx_tune_opts: [INFO] MAX_CPU=${MAX_CPU}"
	echo "nginx_tune_opts: [INFO] PROCESSES=${PROCESSES}"
	echo "nginx_tune_opts: [INFO] CONNECTIONS=${CONNECTIONS}"
	echo "nginx_tune_opts: [INFO] KEEPALIVE_REQUESTS=${KEEPALIVE_REQUESTS}"
	echo "nginx_tune_opts: [INFO] THREADS=${THREADS}"
	echo "nginx_tune_opts: [INFO] THREAD_QUEUE=${THREAD_QUEUE}"
